...
const StakingInterface = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden py-20">
      <div className="relative z-10 w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-4">
        {/* Left column - Staking Form */}
        <div className=" backdrop-blur-sm p-8 rounded-lg border border-amber-800/30">
      ...
      {showConfirmation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
          <div className="animate-in fade-in zoom-in duration-300 max-w-md w-full mx-4">
            <div className="bg-gradient-to-b  border-2 border-yellow-500 rounded-lg shadow-[0_0_30px_rgba(255,215,0,0.2)] overflow-hidden">
              <div className="p-6">
