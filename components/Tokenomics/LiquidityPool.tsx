          ...
          {isInView && (
            ...
            >
              <div className="max-w-4xl space-y-6">
                ...
                >
                  <strong>Master Number 11 | The Gateway</strong>
                  <br />
                  For freedom, flow, and access. This ensures the energy can
                  move. That new people can enter. That the system stays alive.
                </motion.p>
              </div>
            </motion.div>
          )}
