...
export default function PhasePrices() {
  ...
  const headerOpacity = useTransform(smoothScrollYProgress, [textAnimStart, textAnimStart + step], [0, 1])
  const headerY = useTransform(smoothScrollYProgress, [textAnimStart, textAnimStart + step], [initialY, finalY])

  // Row 1 (Phase 1)
  const row1Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step, textAnimStart + step * 2], [0, 1])
  ...
  // Row 2 (Phase 2)
  const row2Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step * 2, textAnimStart + step * 3], [0, 1])
  ...
  // Row 3 (Phase 3)
  const row3Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step * 3, textAnimStart + step * 4], [0, 1])
  ...
  // Row 4 (Phase 4)
  const row4Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step * 4, textAnimStart + step * 5], [0, 1])
  ...
  // Row 5 (Phase 5)
  const row5Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step * 5, textAnimStart + step * 6], [0, 1])
  ...
  // Row 6 (Phase 6)
  const row6Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step * 6, textAnimStart + step * 7], [0, 1])
  ...
  // Row 7 (Phase 7)
  const row7Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step * 7, textAnimStart + step * 8], [0, 1])
  ...
  // Row 8 (Phase 8)
  const row8Opacity = useTransform(smoothScrollYProgress, [textAnimStart + step * 8, textAnimStart + step * 9], [0, 1])
