...
export default function ReadySection() {
  ...
  // New multi-step opacity transform:
  // Fade in from 0% to 5% scroll and fade out from 95% to 100% scroll.
  ...
  // The rest of your transforms remain unchanged.
  ...
  return (
    // Outer section with height 400vh to provide scroll space for pinning/unpinning.
    <section ref={ref} className="relative w-full h-[400vh] bg-black font-montserrat">
      {/* Fixed container that pins the content in the viewport during this section's active scroll range.
          (pt-20 moves content down so that a header placed above doesn't cover it) */}
      <div className="fixed inset-0 overflow-hidden pt-20">
        <motion.div style={{ opacity: contentOpacity }} className="relative h-full w-full">
          ...
          <div className="absolute inset-0 z-10 flex flex-col justify-center items-center space-y-12">
            <motion.h2 style={{ opacity: text1Opacity, y: text1Y }} className="text-white text-5xl font-bold text-center">
              You have seen the <span className="text-[#A67C00]">Earth.</span>
            </motion.h2>
            <motion.h2 style={{ opacity: text2Opacity, y: text2Y }} className="text-white text-5xl font-bold text-center">
              You felt the <span className="text-[#5FB9C3]">Flow</span>, the <span className="text-[#539241]">Vision</span>, the <span className="text-[#892D06]">Balance.</span>
            </motion.h2>
            <motion.h2 style={{ opacity: text3Opacity, y: text3Y }} className="text-white text-5xl font-bold text-center">
              You are not joining a <span className="text-[#A67C00]">project.</span>
            </motion.h2>
            <motion.h2 style={{ opacity: text4Opacity, y: text4Y }} className="text-white text-5xl font-bold text-center">
              You are remembering your <span className="text-[#A67C00]">role.</span>
            </motion.h2>
            <motion.h2 style={{ opacity: text4Opacity, y: text4Y }} className="text-white text-5xl font-bold">
              <Button
